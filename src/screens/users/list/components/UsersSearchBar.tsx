// src/screens/users/list/components/UsersSearchBar.tsx
    ...
    <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 flex flex-col md:flex-row gap-4 relative z-10">
      <div className="relative flex-1 group">
        ...
        <input
          ...
          className="w-full bg-slate-50 border-none rounded-xl py-3 pl-11 pr-4 text-sm text-slate-700 font-medium placeholder:text-slate-400 focus:bg-white focus:ring-2 focus:ring-purple-500/20 transition-all outline-none"
        />
      </div>

      <div className="flex gap-3">
        {/* Role Select */}
        <div className="relative bg-slate-50 rounded-xl min-w-[160px]">
          <Shield
          ...
          <select
            ...
            className="w-full bg-transparent border-none appearance-none py-3 pl-10 pr-10 text-sm font-medium text-slate-600 focus:ring-2 focus:ring-purple-500/20 rounded-xl outline-none cursor-pointer"
          >
            {roleOptions.map((opt) => (
