...
const CaseDetailPage = () => {
  ...
  if (isLoading) return <div className="flex items-center justify-center h-full text-slate-400 font-medium animate-pulse">Cargando caso...</div>;
  if (error || !caseItem) return <div className="p-8 text-center text-red-500 font-bold">{error || "Caso no encontrado"}</div>;
